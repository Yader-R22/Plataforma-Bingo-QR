                ...
                <div className="flex gap-2">
                  {activatorStatus.whatsapp_group_link && (
                    <a href={activatorStatus.whatsapp_group_link} target="_blank" rel="noopener noreferrer"
                      className="flex-1 min-w-0 py-3 px-2 rounded-xl font-bold flex flex-col items-center justify-center gap-1 text-center"
                      ...
                      <span className="text-[11px] leading-tight">Grupo de activadores</span>
                    </a>
                  )}
                  <button
                    className={`${activatorStatus.whatsapp_group_link ? "flex-1" : "w-full"} min-w-0 py-3 px-2 rounded-xl font-bold flex flex-col items-center justify-center gap-1 text-center`}
                    ...
                    <span className="text-[11px] leading-tight">Compartir por WhatsApp</span>
                  </button>
                </div>
              </div>
              {referralHistory && (
