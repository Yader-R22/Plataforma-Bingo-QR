                ...
                return (
                  <div key={p.id} className="bg-card border rounded-2xl overflow-hidden">
                    ...
                    <div className="p-4 space-y-3">
                      ...
                      {/* Fila 2: ganador + contacto */}
                      <div className="flex gap-2 items-stretch">
                        {/* Ganador — crece para ocupar el espacio */}
                        <div className="flex-1 rounded-xl px-3 py-2.5 space-y-0.5" style={{ background: "hsl(var(--muted) / 0.5)" }}>
                        ...
                        {/* Contacto — solo lo que ocupa el botón */}
                        <div className="flex flex-col items-center justify-center gap-1 px-1">
                          ...
                          {p.user_phone ? (
                            ...
                            <p className="text-xs text-muted-foreground italic">Sin tel.</p>
                          )}
                        </div>
                      </div>
